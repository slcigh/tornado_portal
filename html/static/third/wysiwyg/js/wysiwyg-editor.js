(function(window, document, $, undefined){
                                  ...
                                  placeholder_url, max_imagesize, onImageUpload, onKeyEnter )
    {
        ...
        var content_insertlink = function(wysiwygeditor, $modify_link)
        {
            ...
            var $content = $('<div/>').addClass('wysiwyg-toolbar-form moreUserLink')
                                      .attr('unselectable','on');
            findRole(wysiwygeditor.getSelectedHTML());
            $content.append($inputurl).append($('#moreUserBox').html()).append($okaybutton);
            return $content;
        };
